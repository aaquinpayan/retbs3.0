...
class TaxDeclaration extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['property_owner', 'property_index_no', 'first_name', 'last_name', 'arp_no', 'address', 'classification', 'area', 'market_value', 'actual_use', 'assessment_level', 'assessed_value', 'php', 'total_php', 'effectivity_quarter', 'effectivity_year', 'property_kind', 'location', 'taxability', 'mun_assessor', 'prov_assessor'], 'required'],
            [['survey_no', 'area', 'effectivity_quarter', 'effectivity_year', 'cancels_arp_no','cancels_assessed_value', 'lot_no', 'blk_no','cancels_owner'], 'default', 'value' => null],
