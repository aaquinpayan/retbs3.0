	    ...
	    <?php
	        ...
	        echo SideNav::widget([
	            ...
	            'items' => [
	                ...
	                ['label' => 'Tax Declaration', 'icon' => 'home', 'url' => ['tax-declaration/index']], //edit pa to besh
	                ['label' => 'Statement of Account', 'icon' => 'home', 'url' => ['account-statement/index']], //edit pa to besh
